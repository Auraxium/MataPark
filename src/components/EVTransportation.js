...
function EVTransportation() {
    return (
      ...
      position="absolute"
      width="80%"
      style={{ aspectRatio: "15/7" }}çç

    />

<h6 id="nav" align="center">
					<a href="#Current">Charging Update </a>|
					<a href="#Skateboards">Skateboards</a>|
					<a href="#Metro">Metro U-Pass</a>
  ...
  <h3 id = "Skateboards">Use of Skateboards, Roller-Skates, Hoverboards, and Other Similar Equipment</h3>
       ...
       <p> The use of in-line skates, roller skates, skateboards, electronic skateboards and other similar skating equipment on the
grounds of the campus for individual transportation is permitted. Skaters are required to be aware of pedestrians and be at a safe speed.
</p>
<h3 id = "Metro">Metro U-Pass Information</h3>
<p>Spring 2023 U-Passes will be available for purchase and renewal at the AS Ticket Office starting January 4, 2023. 
  The price is still $95 and it is valid from 1/09/23 through 5/28/23. To qualify for the Metro U-Pass,
  you must be enrolled in 6 or more units for undergraduate students and 3 or more units for graduate students. To purchase a U-Pass, please follow the steps below.</p>
Online: <br />
					<ul className="aline-start" style={{ listStyleType: "none" }}>
