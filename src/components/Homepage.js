  ...
  return (
    <div className="container">
      <div className="row text-center text-white bg-black">
        <div className="col-3 py-4" onClick={() => nav("/ParkingInfo")}>Parking Information</div>
      ...
      <div className="row">
        ...
        <div className="col-7 text-center ">
          ...
          <p className="mt-4">
            Welcome to Matapark, a parking app just for CSUN Matadors and visitors alike. This app is dedicated to making sure your parking experience is easy and convenient, from getting parking information and finding spots to permit buying help and getting closure alerts, we have it all. <br/> Enjoy!
          </p>
          <p className="">
            NOTE: Currently CSUN uses license plate recognition software mounted on their parking
            vehicles that will read plates and see if a valid CSUN parking permit is
